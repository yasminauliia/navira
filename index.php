...
<nav id="navbar">
    ...
    <div class="nav-links">
        ...
        <a href="user/register.php" class="btn-daftar">Daftar</a>
    </div>
</nav>
    ...
    <div class="jadwal-grid">
        <div class="jcard">
            ...
            <div class="jcard-body">
                ...
                <div class="jdate">📅 25 April 2028 &nbsp;·&nbsp; ⏰ 08:00 WIB</div>
                <div class="price">Rp 84.000 <small>/ orang</small></div>
        ...
        <div class="jcard">
            ...
            <div class="jcard-body">
                ...
                <div class="price">Rp 20.000 <small>/ orang</small></div>
                <a href="user/beli_tiket.php" class="btn-jcard">Pesan Sekarang</a>
            </div>
        </div>
        <div class="jcard">
...
<div class="cta-section">
    ...
    <p>Daftar sekarang dan nikmati kemudahan memesan tiket kapal laut.</p>
    <div class="cta-btns">
        <a href="user/register.php" class="btn-hero-main">Daftar Sekarang</a>
